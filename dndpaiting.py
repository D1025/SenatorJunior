...
def Paint(Statystyki):

  img = Image.open('Arts/Stats/DnDAE.png')
  I1 = ImageDraw.Draw(img)
  try:
    os.remove("Arts/Stats/DnDCopy.png")
  except:
    pass
  ...
  img.save("Arts/Stats/DnDCopy.png")
  img.close()
